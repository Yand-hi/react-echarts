...
export const Chart2 = () => {
  ...
  const data = [
    { name: '城关区公安局', 2011: 3, 2012: 8 },
    { name: '七里河区公安局', 2011: 2, 2012: 5 },
    { name: '西固区公安局', 2011: 7, 2012: 3 },
    { name: '安宁区公安局', 2011: 9, 2012: 10 },
    { name: '红谷区公安局', 2011: 4, 2012: 6 },
    { name: '永登县公安局', 2011: 5, 2012: 7 },
    { name: '皋兰县公安局', 2011: 6, 2012: 4 },
    { name: '榆中县公安局', 2011: 8, 2012: 5 },
    { name: '新区公安局', 2011: 1, 2012: 2 },
  ];
  useEffect(() => {
    setInterval(() => {
      const newData = [
